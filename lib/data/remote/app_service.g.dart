...
class _AppService implements AppService {
  ...
  @override
  Future<HttpResponse<dynamic>> getSingleTransaction(
    String id,
    String token,
  ) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> createPaypalDepositTransaction(
    String token,
    Map<String, dynamic> request,
  ) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> createVNPayTransaction(
    String token,
    Map<String, dynamic> request,
  ) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> createPaypalWithdrawTransaction(
    String token,
    Map<String, dynamic> request,
  ) async {
    const _extra = <String, dynamic>{};
